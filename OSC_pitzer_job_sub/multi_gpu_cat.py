...
ns = 26
ne = 50
n_proc = 6 # number of processors that did the calculations
istart = 0*n_proc
iend = 1*n_proc
dnamein = '/fs/ess/PAS1751/dustin/donut_paper1/donut_cc85_a/output/'
dnameout = '/fs/ess/PAS1751/dustin/donut_paper1/donut_cc85_a/output_cat/'
DE = 1
SCALAR = 1 
...
for n in range(ns, ne+1):
  ...
  for i in range(istart, iend):
    ...
    if (i == 0):
      ...
      if (SCALAR):
        SC = fileout.create_dataset("scalar0", (nx, ny, nz), chunks=True)
